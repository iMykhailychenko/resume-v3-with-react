...
const Reason = ({ content: { title, firstText, secondText, relink } }: Props): ReactElement => {
            ...
            <section className={css.content}>
                    ...
                    {mobile ? (
                        <>
                            <video autoPlay loop muted playsInline className={css.video}>
                                <source src="/images/content/reason/reason-1.webm" type="video/webm" />
                ...
                <div className={css.blockRight}>
                    {mobile ? (
                        <>
                            <video autoPlay loop muted playsInline className={css.video}>
                                <source src="/images/content/reason/reason-2.webm" type="video/webm" />
