...
const Download: React.FC<Props> = ({
  ...
  <main className="container">
    <PageFirstBlock
      title={title}
      img="/images/emoji/download.png"
      webp="/images/emoji/download.webp"
    />
      ...
      <div className={css.block}>
        ...
        <div className={clsx(css.files, 'border-top')}>
          <ul className={css.list}>
            <li>
              <a
                className={clsx(css.link, 'reversBackground')}
                href="/files/resume-ru.pdf"
                download
              >
                {`${btn} pdf UA`}
              </a>
