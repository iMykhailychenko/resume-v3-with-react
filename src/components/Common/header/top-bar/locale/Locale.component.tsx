    ...
    return (
        <>
            ...
            <ul className={css.list}>
                <li>
                    <button className={locale === 'UA' ? css.active : css.item} onClick={handleLang('UA')}>
                        UA
                    </button>
                </li>
                <li>
                    <button className={locale === 'RU' ? css.active : css.item} onClick={handleLang('RU')}>
                        RU
                    </button>
                </li>
                <li>
                    <button className={locale === 'EN' ? css.active : css.item} onClick={handleLang('EN')}>
                        EN
                    </button>
                </li>
            </ul>
