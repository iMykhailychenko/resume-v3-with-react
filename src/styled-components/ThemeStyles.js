...
export const ThemeStyles = createGlobalStyle`
  ...
  .page-scroll {
    border: ${props => (props.theme === 'light' ? '0.1rem solid rgb(0, 0, 0)' : '0.1rem solid rgb(255, 255, 255)')};
  }
  ...
  .border-top {
    border-top: ${props => (props.theme === 'light' ? '0.1rem solid rgb(0, 0, 0)' : '0.1rem solid rgb(255, 255, 255)')};
  }
  ...
  .reversBackground {
    background: ${props => (props.theme === 'light' ? 'rgb(0, 0, 0)' : 'rgb(255, 255, 255)')};
    color: ${props => (props.theme === 'light' ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 0)')};
  }
`;
